...
def answer_question(query, k=10, max_tokens=256):
    ...
    if answer:
        ...
        print("Kết quả cuối cùng:", answer)
        return answer
    ...
    print("\n--- Kết quả truy vấn trong data (top chunks) ---")
...
"""
    ...
    print("\n--- Kết quả cuối cùng từ ChatGPT ---\n")
    print(answer)
    return answer

if __name__ == "__main__":
    test_query = "Vắng học không phép bị trừ bao nhiêu điểm?"
    answer_question(test_query, k=10)
